...
[TaskDescription("Run unit and integration tests on Debug artifacts")]
public class RunTestsOnDebugArtifactsTask : FrostingTask<ShatilayaContext> {
    public override void Run(ShatilayaContext context) {
        context.Information("Running unit and integration tests on Debug artifacts");
